...
#  1. Bubble Sort (Easiest to understand)

###  Idea

Compare adjacent elements and swap if they are in the wrong order.
Big numbers “bubble” to the end.
...
#  4. Merge Sort (Important for interviews)
...
Pick a pivot → smaller left → bigger right → sort recursively.
